      ...
      <div className="flex  justify-center gap-4 flex-wrap mt-6">
          <Card
            ...
            className={clsx('w-[300px] flex flex-col justify-between', {
              'border-2 border-primary': '1px solid',
            })}
          >
            <CardHeader>
              <CardTitle className="text-orange">Pro</CardTitle>
              <CardDescription>
            ...
            <CardFooter className="flex flex-col items-start gap-4">
              ...
              <Link
                href={`/dashbord?plan=`}
                className="bg-[#03070F] text-white border-orange border-2 p-2 w-full text-center font-bold rounded-md"
              >
                Get Started
              </Link>
            </CardFooter>
